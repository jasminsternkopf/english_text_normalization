from english_text_normalization.adjustments.normalizaton_of_certain_words_and_abbr import (
    change_p_dot_before_number_into_page,
    normalize_per_cent_dot_if_not_end_of_sentence, replace_no_with_number)
...
# region normalize_per_cent_dot_if_not_end_of_sentence


def test_normalize_per_cent_dot_if_not_end_of_sentence():
  text = "Its fibre is three per cent., and carbo-hydrates sixty-six point five per cent. Did you know that?"
  res = normalize_per_cent_dot_if_not_end_of_sentence(text)

  assert res == "Its fibre is three percent, and carbo-hydrates sixty-six point five percent. Did you know that?"


def test_normalize_per_cent_dot_if_not_end_of_sentence__with_quotation_marks():
  text = "\"Its fibre is three per cent. and carbo-hydrates sixty-six point five per cent.\" \"Did you know that?\""
  res = normalize_per_cent_dot_if_not_end_of_sentence(text)
...
def test_normalize_per_cent_dot_if_not_end_of_sentence__per_cent_at_end_of_direct_speech_but_not_of_sentence():
...
def test_normalize_per_cent_dot_if_not_end_of_sentence__question_mark_after_percent():
...
def test_normalize_per_cent_dot_if_not_end_of_sentence__double_hyphen_after_percent():
...
def test_normalize_per_cent_dot_if_not_end_of_sentence__double_hyphen_after_percent_but_end_of_sentence():
  text = "I've got two thousand laid out at seven per cent.--Haven't I, Clara?"
  res = normalize_per_cent_dot_if_not_end_of_sentence(text)
